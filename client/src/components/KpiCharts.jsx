        ...
        {data.every((d) => d.companyCount === 0) ? (
          ...
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={data} margin={{ top: 24, right: 16, left: 8, bottom: 8 }}>
              ...
              <Tooltip />
              <Bar dataKey="companyCount" name="Companies" fill="#2563eb" radius={[4, 4, 0, 0]}>
                <LabelList dataKey="companyCount" position="top" style={{ fontSize: 12, fontWeight: 600, fill: '#1e293b' }} />
              </Bar>
            </BarChart>
          </ResponsiveContainer>
        )}
